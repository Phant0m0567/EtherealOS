...
function App() {
  ...
  const afterMath = (event) => {
    ...
    var etarget = event && event.target;
    var eelm = etarget && etarget.nodeType === 1 ? etarget : etarget && etarget.parentElement;
    var actionType0 = eelm
      ? getComputedStyle(eelm).getPropertyValue("--prefix")
      : "";
  ...
  window.oncontextmenu = (e) => {
    ...
    var menuTarget = null;
    var etarget = e && e.target;
    var eelm = etarget && etarget.nodeType === 1 ? etarget : etarget && etarget.parentElement;
    if (eelm && eelm.closest) {
      menuTarget = eelm.closest("[data-menu]");
    }

    if (menuTarget && menuTarget.dataset.menu != null) {
      data.menu = menuTarget.dataset.menu;
      data.attr = menuTarget.attributes;
      data.dataset = menuTarget.dataset;
      dispatch({
        type: "MENUSHOW",
        payload: data,
      });
