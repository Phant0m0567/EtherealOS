...
export const Explorer = () => {
  ...
  const handleNewItem = () => {
    ...
    dispatch({
      type: createFile ? "FILESAVE" : "FILEMKDIR",
      payload: {
        folderId,
        name: finalName,
        content: createFile ? "" : undefined,
      },
    });
  };
  ...
  return (
    ...
    >
      ...
      <div className="windowScreen flex flex-col">
        <Ribbon onNewItem={handleNewItem} />
        ...
        <div className="gridshow" data-size="lg">
          {fdata.data.map((item, i) => {
            const isImageFile =
              ...
              /^data:image\//i.test(item.data.trim());
