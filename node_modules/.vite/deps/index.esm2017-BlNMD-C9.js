...
//#region windows/node_modules/@firebase/util/dist/index.esm2017.js
/**
* @license
...
//#endregion
//#region windows/node_modules/@firebase/component/dist/esm/index.esm2017.js
/**
...
//#endregion
//#region windows/node_modules/@firebase/logger/dist/esm/index.esm2017.js
/**
* @license
* Copyright 2017 Google LLC
*
...
//#endregion
//#region windows/node_modules/idb/build/wrap-idb-value.js
...
//#endregion
//#region windows/node_modules/idb/build/index.js
/**
* Open a database.
*
...
//#endregion
//#region windows/node_modules/@firebase/app/dist/esm/index.esm2017.js
var index_esm2017_exports = /* @__PURE__ */ __exportAll({
...
function getDbPromise() {
	if (!dbPromise) dbPromise = openDB(DB_NAME, DB_VERSION, { upgrade: (db, oldVersion) => {
		...
		throw ERROR_FACTORY$1.create("storage-open", { originalErrorMessage: e.message });
	});
	return dbPromise;
}
async function readHeartbeatsFromIndexedDB(app) {
	var _a;
	try {
		return (await getDbPromise()).transaction(STORE_NAME).objectStore(STORE_NAME).get(computeKey(app));
	} catch (e) {
		throw ERROR_FACTORY$1.create("storage-get", { originalErrorMessage: (_a = e) === null || _a === void 0 ? void 0 : _a.message });
	}
}
async function writeHeartbeatsToIndexedDB(app, heartbeatObject) {
	...
	try {
		...
		throw ERROR_FACTORY$1.create("storage-set", { originalErrorMessage: (_a = e) === null || _a === void 0 ? void 0 : _a.message });
	}
}
...
//#endregion
//#region windows/node_modules/@firebase/app-compat/dist/esm/index.esm2017.js
/**
* @license
* Copyright 2020 Google LLC
*
...
var FirebaseAppImpl = class {
	...
	*/
	_getService(name, instanceIdentifier = DEFAULT_ENTRY_NAME) {
		...
		if (!provider.isInitialized() && ((_a = provider.getComponent()) === null || _a === void 0 ? void 0 : _a.instantiationMode) === "EXPLICIT") provider.initialize();
...
//#endregion
export { querystringDecode as C, querystring as S, isIE as _, LogLevel as a, isNode as b, ErrorFactory as c, createSubscribe as d, extractQuerystring as f, isEmpty as g, isBrowserExtension as h, registerVersion as i, FirebaseError as l, getUA as m, SDK_VERSION as n, Logger as o, getModularInstance as p, _registerComponent as r, Component as s, firebase as t, base64Decode as u, isIndexedDBAvailable as v, isReactNative as x, isMobileCordova as y };
