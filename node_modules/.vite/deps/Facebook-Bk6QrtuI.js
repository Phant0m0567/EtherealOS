...
//#region windows/node_modules/react-player/lib/players/Facebook.js
var require_Facebook = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	__export(Facebook_exports, { default: () => Facebook });
			...
			(0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL, SDK_GLOBAL_READY).then((FB) => {
				...
				FB.Event.subscribe("xfbml.ready", (msg) => {
					if (msg.type === "video" && msg.id === this.playerID) {
						...
						if (this.props.muted) this.callPlayer("mute");
						else this.callPlayer("unmute");
						this.props.onReady();
