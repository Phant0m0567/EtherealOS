import { n as _typeof } from "./toPropertyKey-ClBjnpwh.js";
import { n as _classCallCheck, t as _createClass } from "./createClass-BtHLCXqG.js";
import { t as _defineProperty } from "./defineProperty-Bzwx-7iJ.js";
import { n as _unsupportedIterableToArray, r as _arrayWithHoles, t as _nonIterableRest } from "./nonIterableRest-BSknRhyv.js";
//#region windows/node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js
function _assertThisInitialized(e) {
	if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
	return e;
}
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/setPrototypeOf.js
...
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/inherits.js
...
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/possibleConstructorReturn.js
...
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js
...
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/iterableToArray.js
function _iterableToArray(r) {
	if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r);
}
//#endregion
//#region windows/node_modules/@babel/runtime/helpers/esm/toArray.js
function _toArray(r) {
	return _arrayWithHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableRest();
}
//#endregion
//#region windows/node_modules/i18next/dist/esm/i18next.js
	...
	_createClass(Logger, [
		...
		},
		{
			...
			value: function create(moduleName) {
				return new Logger(this.logger, _objectSpread(_objectSpread({}, { prefix: "".concat(this.prefix, ":").concat(moduleName, ":") }), this.options));
			}
		},
		{
			key: "clone",
	...
	_createClass(ResourceStore, [
		...
		},
		{
			...
			value: function addResourceBundle(lng, ns, resources, deep, overwrite) {
				...
				else pack = _objectSpread$1(_objectSpread$1({}, pack), resources);
	...
	_createClass(Translator, [
			...
			value: function translate(keys, options, lastKey) {
				...
				if (handleAsObjectInI18nFormat && res && typeof res !== "string" && typeof res !== "boolean" && typeof res !== "number" && noObject.indexOf(resType) < 0 && !(typeof joinArrays === "string" && resType === "[object Array]")) {
					if (!options.returnObjects && !this.options.returnObjects) {
						...
						var r = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(resUsedKey, res, _objectSpread$2(_objectSpread$2({}, options), {}, { ns: namespaces })) : "key '".concat(key, " (").concat(this.language, ")' returned an object instead of string.");
						if (returnDetails) {
							resolved.res = r;
							return resolved;
						}
					...
					if (usedKey || usedDefault || updateMissing) {
						...
						if (keySeparator) {
							var fk = this.resolve(key, _objectSpread$2(_objectSpread$2({}, options), {}, { keySeparator: false }));
		...
		},
		{
			...
			value: function extendTranslation(res, key, options, resolved, lastKey) {
				var _this3 = this;
				if (this.i18nFormat && this.i18nFormat.parse) res = this.i18nFormat.parse(res, _objectSpread$2(_objectSpread$2({}, this.options.interpolation.defaultVariables), options), resolved.usedLng, resolved.usedNS, resolved.usedKey, { resolved });
				else if (!options.skipInterpolation) {
					if (options.interpolation) this.interpolator.init(_objectSpread$2(_objectSpread$2({}, options), { interpolation: _objectSpread$2(_objectSpread$2({}, this.options.interpolation), options.interpolation) }));
				...
				if (res !== void 0 && res !== null && postProcessorNames && postProcessorNames.length && options.applyPostProcessor !== false) res = postProcessor.handle(postProcessorNames, res, key, this.options && this.options.postProcessPassResolved ? _objectSpread$2({ i18nResolved: resolved }, options) : options, this);
				return res;
			}
		},
		{
		...
		},
		{
			...
			value: function interpolate(str, data, lng, options) {
				...
				var handleFormat = function handleFormat(key) {
					...
					return _this.format(getPathWithDefaults(data, defaultData, k), f, lng, _objectSpread$3(_objectSpread$3(_objectSpread$3({}, options), data), {}, { interpolationkey: k }));
				};
				this.resetRegExp();
	...
	function Formatter() {
		...
		this.formats = {
			...
			currency: createCachedFormatter(function(lng, options) {
				var formatter = new Intl.NumberFormat(lng, _objectSpread$4(_objectSpread$4({}, options), {}, { style: "currency" }));
				return function(val) {
					return formatter.format(val);
				};
			}),
	...
	_createClass(Connector, [
					...
					if (q.pendingCount === 0 && !q.done) {
						Object.keys(q.loaded).forEach(function(l) {
							...
							if (loadedKeys.length) loadedKeys.forEach(function(ns) {
								if (loaded[l][ns] === void 0) loaded[l][ns] = true;
							});
						});
						q.done = true;
		...
		},
		{
			...
			value: function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
				...
				if (this.backend && this.backend.create) this.backend.create(languages, namespace, key, fallbackValue, null, _objectSpread$5(_objectSpread$5({}, options), {}, { isUpdate }));
	...
	_createClass(I18n, [
		{
			...
			value: function init() {
				...
				if (this.options.compatibilityAPI !== "v1") this.options.interpolation = _objectSpread$6(_objectSpread$6({}, defOpts.interpolation), this.options.interpolation);
		...
		},
		{
			...
			value: function getFixedT(lng, ns, keyPrefix) {
				...
				var fixedT = function fixedT(key, opts) {
					...
					} else options = _objectSpread$6({}, opts);
		...
		},
		{
			...
			value: function dir(lng) {
				...
				return [
					...
					"sam",
					"ckb"
				].indexOf(this.services.languageUtils.getLanguagePartFromCode(lng)) > -1 || lng.toLowerCase().indexOf("-arab") > 1 ? "rtl" : "ltr";
			}
		},
		{
			key: "cloneInstance",
			value: function cloneInstance() {
				...
				var mergedOptions = _objectSpread$6(_objectSpread$6(_objectSpread$6({}, this.options), options), { isClone: true });
