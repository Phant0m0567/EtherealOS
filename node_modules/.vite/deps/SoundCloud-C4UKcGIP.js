...
//#region windows/node_modules/react-player/lib/players/SoundCloud.js
var require_SoundCloud = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	__export(SoundCloud_exports, { default: () => SoundCloud });
			...
			(0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL).then((SC) => {
				...
				if (!isReady) {
					...
					this.player.bind(PAUSE, () => {
						if (this.duration - this.currentTime < .05) return;
						this.props.onPause();
					});
