...
//#region windows/node_modules/react-player/lib/players/Wistia.js
var require_Wistia = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Wistia_exports = {};
	__export(Wistia_exports, { default: () => Wistia });
	...
	var Wistia = class extends import_react.Component {
		...
		load(url) {
			...
			(0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL).then((Wistia2) => {
				if (config.customControls) config.customControls.forEach((control) => Wistia2.defineControl(control));
