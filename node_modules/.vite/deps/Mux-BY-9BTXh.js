...
import { t as require_patterns } from "./react-player.js";
//#region windows/node_modules/react-player/lib/players/Mux.js
var require_Mux = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Mux_exports = {};
	__export(Mux_exports, { default: () => Mux });
	...
	var Mux = class extends import_react.Component {
		...
		componentDidMount() {
			...
			if (playbackId) this.player.playbackId = playbackId;
		}
		...
		async load(url) {
			...
			if (!((_a = globalThis.customElements) == null ? void 0 : _a.get("mux-player"))) try {
				await import(
					/* webpackIgnore: true */
					`${SDK_URL.replace("VERSION", config.version)}`
);
				this.props.onLoaded();
			} catch (error) {
				onError(error);
		...
		render() {
			...
			if (controls === false) style["--controls"] = "none";
