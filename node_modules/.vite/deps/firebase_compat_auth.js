import { C as querystringDecode, S as querystring, _ as isIE, a as LogLevel, b as isNode, c as ErrorFactory, d as createSubscribe, f as extractQuerystring, g as isEmpty, h as isBrowserExtension, i as registerVersion, l as FirebaseError, m as getUA, n as SDK_VERSION, o as Logger, p as getModularInstance, r as _registerComponent, s as Component, t as firebase, u as base64Decode, v as isIndexedDBAvailable, x as isReactNative, y as isMobileCordova } from "./index.esm2017-BlNMD-C9.js";
//#region windows/node_modules/tslib/tslib.es6.mjs
function __rest(s, e) {
	var t = {};
...
//#endregion
//#region windows/node_modules/@firebase/auth/dist/esm2017/index-90ebcfae.js
/**
* @license
...
var ProactiveRefresh = class {
	...
	async iteration() {
		...
		try {
			...
			if (((_a = e) === null || _a === void 0 ? void 0 : _a.code) === `auth/network-request-failed`) this.schedule(true);
			return;
		}
		this.schedule();
	}
...
async function _reloadWithoutSaving(user) {
	...
	_assert$4(response === null || response === void 0 ? void 0 : response.users.length, auth, "internal-error");
...
var StsTokenManager = class StsTokenManager {
	...
	async getToken(auth, forceRefresh = false) {
		_assert$4(!this.accessToken || this.refreshToken, auth, "user-token-expired");
	...
	*/
	...
	async reloadAndSetCurrentUserOrClear(user) {
		...
		try {
			...
			if (((_a = e) === null || _a === void 0 ? void 0 : _a.code) !== `auth/network-request-failed`) return this.directlySetCurrentUser(null);
		}
	...
	*/
	...
	async _getIdTokenResponse(auth) {
		switch (this.signInMethod) {
			case "password": return signInWithPassword(auth, {
...
async function _reauthenticate(user, credential, bypassAuthState = false) {
	...
	try {
		...
		if (((_a = e) === null || _a === void 0 ? void 0 : _a.code) === `auth/user-not-found`) _fail(auth, "user-mismatch");
		throw e;
	}
}
/**
...
function _setActionCodeSettingsOnRequest(auth, request, actionCodeSettings) {
	var _a;
	_assert$4(((_a = actionCodeSettings.url) === null || _a === void 0 ? void 0 : _a.length) > 0, auth, "invalid-continue-uri");
...
var MultiFactorUserImpl = class MultiFactorUserImpl {
	...
	async unenroll(infoOrUid) {
		...
		try {
			...
			if (((_a = e) === null || _a === void 0 ? void 0 : _a.code) !== `auth/user-token-expired`) throw e;
		}
	}
};
	...
	onStorageEvent(event, poll = false) {
		...
		if (this.safariLocalStorageNotSynced) {
			...
			if (event.newValue !== storedValue) {
				if (event.newValue !== null) this.storage.setItem(key, event.newValue);
...
async function _verifyPhoneNumber(auth, options, verifier) {
	...
	try {
		_assert$4(typeof recaptchaToken === "string", auth, "argument-error");
		_assert$4(verifier.type === RECAPTCHA_VERIFIER_TYPE, auth, "argument-error");
...
var BrowserPopupRedirectResolver = class {
	...
	async _openPopup(auth, provider, authType, eventId) {
		...
		return _open(auth, _getRedirectUrl(auth, provider, authType, _getCurrentUrl(), eventId), _generateEventId());
	}
	...
	async initAndGetManager(auth) {
		...
		iframe.register("authEvent", (iframeEvent) => {
			_assert$4(iframeEvent === null || iframeEvent === void 0 ? void 0 : iframeEvent.authEvent, auth, "invalid-auth-event");
...
function registerAuth(clientPlatform) {
	_registerComponent(new Component("auth", (container, { options: deps }) => {
		...
		return ((app, heartbeatServiceProvider) => {
			...
			_assert$4(!(authDomain === null || authDomain === void 0 ? void 0 : authDomain.includes(":")), "argument-error", { appName: app.name });
			const authInstance = new AuthImpl(app, heartbeatServiceProvider, {
				apiKey,
				authDomain,
				clientPlatform,
...
//#endregion
//#region windows/node_modules/@firebase/auth/dist/esm2017/internal.js
/**
* @license
* Copyright 2021 Google LLC
*
...
function _checkCordovaConfiguration(auth) {
	...
	_assert$4(typeof ((_a = win === null || win === void 0 ? void 0 : win.universalLinks) === null || _a === void 0 ? void 0 : _a.subscribe) === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-universal-links-plugin-fix" });
	_assert$4(typeof ((_b = win === null || win === void 0 ? void 0 : win.BuildInfo) === null || _b === void 0 ? void 0 : _b.packageName) !== "undefined", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-buildInfo" });
	_assert$4(typeof ((_e = (_d = (_c = win === null || win === void 0 ? void 0 : win.cordova) === null || _c === void 0 ? void 0 : _c.plugins) === null || _d === void 0 ? void 0 : _d.browsertab) === null || _e === void 0 ? void 0 : _e.openUrl) === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-browsertab" });
	_assert$4(typeof ((_h = (_g = (_f = win === null || win === void 0 ? void 0 : win.cordova) === null || _f === void 0 ? void 0 : _f.plugins) === null || _g === void 0 ? void 0 : _g.browsertab) === null || _h === void 0 ? void 0 : _h.isAvailable) === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-browsertab" });
	_assert$4(typeof ((_k = (_j = win === null || win === void 0 ? void 0 : win.cordova) === null || _j === void 0 ? void 0 : _j.InAppBrowser) === null || _k === void 0 ? void 0 : _k.open) === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-inappbrowser" });
}
/**
...
//#endregion
//#region windows/node_modules/@firebase/auth-compat/dist/index.esm2017.js
...
function credentialFromObject(object) {
	...
	switch (providerId) {
		...
		default:
			...
			if (!oauthAccessToken && !oauthTokenSecret && !oauthIdToken && !pendingToken) return null;
			if (pendingToken) {
				if (providerId.startsWith("saml.")) return SAMLAuthCredential._create(providerId, pendingToken);
...
var RecaptchaVerifier = class {
	constructor(container, parameters, app = firebase.app()) {
		var _a;
		_assert((_a = app.options) === null || _a === void 0 ? void 0 : _a.apiKey, "invalid-api-key", { appName: app.name });
