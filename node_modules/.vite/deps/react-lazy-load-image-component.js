...
//#region windows/node_modules/react-lazy-load-image-component/build/index.js
	...
	(() => {
		...
		(() => {
			...
			var y = function(e) {
				...
				function h(e) {
					...
					if (function(e, t) {
						...
						t.observer = function(e) {
							return b[e] = b[e] || new IntersectionObserver(y, { rootMargin: e + "px" }), b[e];
						}(r);
					}
					return t;
				}
				return r = h, o = [
					...
					},
					{
						...
						value: function() {
							...
							if (i && "function" != typeof i.type) return t().cloneElement(i, { ref: function(t) {
				...
				], o && l(r.prototype, o), Object.defineProperty(r, "prototype", { writable: !1 }), h;
			}(t().Component);
			d.propTypes = {
			...
			const D = function(e) {
				var r = function(r) {
					...
					function l(e) {
						...
						return "debounce" === e.delayMethod ? r.delayedScroll = m()(o, e.delayTime) : "throttle" === e.delayMethod && (r.delayedScroll = w()(o, e.delayTime)), r.state = { scrollPosition: {
							x: R(),
							y: k()
					...
					]) && E(o.prototype, n), Object.defineProperty(o, "prototype", { writable: !1 }), l;
				}(t().Component);
				return r.propTypes = {
			...
			const W = D(function(e) {
				...
				}]) && B(r.prototype, o), Object.defineProperty(r, "prototype", { writable: !1 }), u;
			}(t().Component));
			function z(e) {
			...
			var H = function(e) {
				...
				function s(e) {
					...
					return t.state = { visible: i }, i && (o(), r()), t.onVisible = t.onVisible.bind(F(t)), t.isScrollTracked = Boolean(n && Number.isFinite(n.x) && n.x >= 0 && Number.isFinite(n.y) && n.y >= 0), t;
				}
				return r = s, (o = [
					{
						key: "componentDidUpdate",
				...
				]) && $(r.prototype, o), Object.defineProperty(r, "prototype", { writable: !1 }), s;
			}(t().Component);
			H.propTypes = {
			...
			var oe = function(e) {
				...
				function u(e) {
					...
					return function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
					}(this, u), (t = c.call(this, e)).state = { loaded: !1 }, t;
				}
				return r = u, (o = [
					{
						key: "onImageLoad",
						value: function() {
							...
							return this.state.loaded ? null : function(t) {
								e.props.onLoad(t), e.props.afterLoad(), e.setState({ loaded: !0 });
							};
						}
					},
					{
						...
						value: function() {
							...
							return t().createElement("img", Q({}, r, { onLoad: this.onImageLoad() }));
						}
					},
					{
				...
				]) && Z(r.prototype, o), Object.defineProperty(r, "prototype", { writable: !1 }), u;
			}(t().Component);
			oe.propTypes = {
