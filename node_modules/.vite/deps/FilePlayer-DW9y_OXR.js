...
import { n as require_utils, t as require_patterns } from "./react-player.js";
//#region windows/node_modules/react-player/lib/players/FilePlayer.js
var require_FilePlayer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	__export(FilePlayer_exports, { default: () => FilePlayer });
	...
	var FilePlayer = class extends import_react.Component {
		...
		load(url) {
			...
			if (this.shouldUseDASH(url)) (0, import_utils.getSDK)(DASH_SDK_URL.replace("VERSION", dashVersion), DASH_GLOBAL).then((dashjs) => {
				...
				else this.dash.updateSettings({ debug: { logLevel: dashjs.Debug.LOG_LEVEL_NONE } });
				this.props.onLoaded();
			});
		...
		getSource(url) {
			...
			if (url instanceof Array || (0, import_utils.isMediaStream)(url) || useHLS || useDASH || useFLV) return;
			if (MATCH_DROPBOX_URL.test(url)) return url.replace("www.dropbox.com", "dl.dropboxusercontent.com");
			return url;
		}
		render() {
			const { url, playing, loop, controls, muted, config, width, height } = this.props;
			const Element = this.shouldUseAudio(this.props) ? "audio" : "video";
			const style = {
